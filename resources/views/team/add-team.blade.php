                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="position-center">
                                <form role="form" action="{{URL::to('/save-team')}}" method="post">
                                    {{ csrf_field() }}
                              ...
                              <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tennhom" class="form-control" id="exampleInputEmail1" placeholder="Phương án 2">
                                </div>
                                 <div class="form-group">
                                    <label for="exampleInputEmail1">Số lượng</label>
                                    <input type="number" min='1' max='4' name="tennhom" class="form-control" id="exampleInputEmail1" placeholder="Phương án 2">
                                </div>
